...
{
    public class IncrementCommentLikeCommandHandler : IRequestHandler<IncrementCommentLikeCommandRequest>
    {
        ...
        public async Task Handle(IncrementCommentLikeCommandRequest request, CancellationToken cancellationToken)
        {
